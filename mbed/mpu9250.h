...
//Set up I2C, (SDA,SCL)
#define I2C_SDA PB_7 // nucleo-L432KC SDA
#define I2C_SCL PB_6 // nucleo-L432KC SDA
...
void readMagData(int16_t * destination, uint8_t * dest_8)
{
  uint8_t rawData[7];  // x/y/z gyro register data, ST2 register stored here, must read ST2 at end of data acquisition
  if(readByte(AK8963_ADDRESS, AK8963_ST1) & 0x01) { // wait for magnetometer data ready bit to be set
  readBytes(AK8963_ADDRESS, AK8963_XOUT_L, 7, &rawData[0]);  // Read the six raw data and ST2 registers sequentially into data array
...
//   writeByte(MPU9250_ADDRESS, SMPLRT_DIV, 0x04);  // Use a 200 Hz rate; the same rate set in CONFIG above
  writeByte(MPU9250_ADDRESS, SMPLRT_DIV, 0x01);     // Use a 500 Hz rate; the same rate set in CONFIG above
